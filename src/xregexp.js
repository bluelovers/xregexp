 ...
 * });
    ...
    XRegExp.replace = (str, search, replacement, scope) => {
        ...
        const result = fixed_1.fixed.replace.call(toObject(str), s2, replacement);
     ...
     * // -> ['..', 'word', '1', '..']
     */
    XRegExp.split = (str, separator, limit) => fixed_1.fixed.split.call(toObject(str), separator, limit);
    /**
